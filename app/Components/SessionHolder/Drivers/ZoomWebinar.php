...
class ZoomWebinar extends Driver
{
    ...
    protected function _register()
    {
        ...
        $sessionStartTime = $sessionStartTime->format('Y-m-d\TH:i:s\Z');
        ...
        $response = Http::withHeaders(['Authorization' => 'Bearer ' . $token])
            ->post(self::ZOOM_API_BASE_URL . "/users/$hostEmail/webinars", [
    ...
    protected function _update()
    {
        ...
        $response = Http::withHeaders(['Authorization' => 'Bearer ' . $token])
            ->patch(self::ZOOM_API_BASE_URL . "/webinars/" . $this->sessionId, $body);
    ...
    protected function _delete()
    {
        $token = $this->generateToken();
        $response = Http::withHeaders(['Authorization' => 'Bearer ' . $token])
            ->delete(self::ZOOM_API_BASE_URL . "/webinars/" . $this->sessionId);
